      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        <div className="animate-fade-in">
          ...
          <div className="mb-12 max-w-2xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">Passionate about building full-stack web applications and experimenting with AI integrations. Crafting digital experiences with modern technologies.</p>
          </div>
